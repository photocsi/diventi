...
if(isset($_SESSION['user_fotografo'])){
  $nomeutente=$_SESSION['user_fotografo'];
...
<!-- inizio navigazione con sottolivelli -->

     <!--  <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-menu-button-wide"></i><span>Modifica album</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
            <a href="carica_img.php">
              <i class="bi bi-circle"></i><span>Carica foto</span>
            </a>
          </li>
          <li>
            <a href="modifica_album.php">
              <i class="bi bi-circle"></i><span>Modifica album</span>
            </a>
          </li>
          <li>
            <a href="impostazioni.php">
              <i class="bi bi-circle"></i><span>Impostazioni album</span>
            </a>
          </li>
      ...
      <!-- fine navigazione con sotto livelli -->
