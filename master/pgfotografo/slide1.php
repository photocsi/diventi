...
$seleziona_foto=$conn->prepare("SELECT * FROM `$id_album` WHERE sotto_cartella= :cartella_scelta OR sotto_cartella= :cartella_scelta2; ");
$seleziona_foto->bindParam(':cartella_scelta', $cartella_scelta);
$seleziona_foto->bindParam(':cartella_scelta2', $cartella_scelta2);
