...
<?php
         ...
         $seleziona_foto=$conn->prepare("SELECT * FROM `$id_album` WHERE sotto_cartella= :cartella_scelta9 OR sotto_cartella= :cartella_scelta10; ");
         $seleziona_foto->bindParam(':cartella_scelta9', $cartella_scelta9);
         $seleziona_foto->bindParam(':cartella_scelta10', $cartella_scelta10);
