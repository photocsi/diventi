...
<?php
         ...
         $seleziona_foto=$conn->prepare("SELECT * FROM `$id_album` WHERE sotto_cartella= :cartella_scelta7 OR sotto_cartella= :cartella_scelta8; ");
         $seleziona_foto->bindParam(':cartella_scelta7', $cartella_scelta7);
         $seleziona_foto->bindParam(':cartella_scelta8', $cartella_scelta8);
