...
session_start();
$cartella_scelta3=$_SESSION['cartella_scelta3'];
$cartella_scelta4=$_SESSION['cartella_scelta4'];
$id_cliente=$_SESSION['id_cliente2'];
if(isset($id_cliente) && isset($cartella_scelta3) && isset($cartella_scelta4) ){
...
<?php
         ...
         $seleziona_foto=$conn->prepare("SELECT * FROM `$id_album` WHERE sotto_cartella= :cartella_scelta3 OR sotto_cartella= :cartella_scelta4; ");
         $seleziona_foto->bindParam(':cartella_scelta3', $cartella_scelta3);
         $seleziona_foto->bindParam(':cartella_scelta4', $cartella_scelta4);
