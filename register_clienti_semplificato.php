              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" action="#" method="POST" novalidate>
                    <div class="col-12">
                      <label for="yourName" class="form-label">Nome e cognome</label>
                    ...
                    <div class="col-12" hidden>
                      ...
                      <input type="email" value="infostudio.csi@libero.it" name="email" class="form-control" id="yourEmail" required>
                    ...
                    <div class="col-12" hidden>
                      ...
                      <input type="password" name="password" class="form-control" id="yourPassword" value="Fotografo1" required >
                    ...
                    <div class="col-12" hidden>
                      ...
                      <div class="input-group has-validation">
                        ...
                        <input type="tel" name="telefono" value="3408252489" class="form-control" id="yourUsername" required>
